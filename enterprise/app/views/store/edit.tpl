...
{block title}门店管理{/block}

{block breadcrumb}
<li>系统管理 <span class="divider">&nbsp;</span></li>
<li><a href="{route('StoreList')}">门店列表</a><span class="divider">&nbsp;</span></li>
<li><a href="{if $data.id gt 0}{route('StoreEdit')}/{$data.id}{else}{route('StoreEdit')}{/if}">添加/编辑门店</a><span class="divider-last">&nbsp;</span></li>
{/block}
...
<div class="row-fluid">
    ...
    <div class="widget">
        ...
        <h4><i class="icon-reorder"> 添加/编辑门店信息</i></h4>
    </div>
    <div class="widget-body form">
    <!-- BEGIN FORM-->
    <form id="form" class="form-horizontal">
        <div class="control-group">
            <label class="control-label"><font style="color:red">*</font>门店名称：</label>
        ...
        <div class="control-group">
            <label class="control-label"><font style="color:red">*</font>门店实景图片：(800*500px)</label>
        ...
        <div class="control-group">
            <label class="control-label"><font style="color:red">*</font>门店类型：</label>

            <div class="controls">
                  <label class="radio">
                        <input type="radio" name="type" {if $data.type eq Store::MAIN }checked{/if} value="{Store::MAIN}" />
                                 总店
                        </label>
                   <label class="radio">
                        <input type="radio" name="type" {if $data.type eq Store::DIRECT }checked{/if} value="{Store::DIRECT}" />
                                 直营店
                   </label>
                   <label class="radio">
                        <input type="radio" name="type" {if $data.type eq Store::BRANCH }checked{/if} value="{Store::BRANCH}" />
                                 加盟店
                   </label>
            </div>
        </div>
        <div class="control-group">
            <label class="control-label"><font style="color:red">*</font>所属组织区域：</label>

            <div class="controls">
                {if $data.group}
                    <div>{$data.group.name} <a href="javascript:;" id="editBelongGroup">[修改]</a>
                    <input type="hidden" name="ori_group_id" value="{$data.group.id}"/></div>
                {/if}
                <select name="group_id[]" class="sub_category" {if $data.group}style="display: none;" {/if}>
                    <option value="">请选择所属组织区域</option>
        ...
        <!--  <div class="control-group">
                              ...
                              <div class="controls">
                                 <select class="span6 chosen"  name="member_id" data-placeholder="选择一位员工" tabindex="1">
                                    <option value="">请选择</option>                                     
                                     {foreach $members as $item}
                                   	<option value="{$item.id}"  {if $item.id eq $data.member_id}selected{/if}>{$item.real_name}</option>
									{/foreach}
                                 </select>
                              </div>
         </div> -->
        ...
        <div class="control-group">
            <label class="control-label"><font style="color:red">*</font>联系人：</label>
        ...
        <div class="control-group">
            <label class="control-label"><font style="color:red">*</font>省市区：</label>
         ...
         <div class="control-group">
            <label class="control-label"><font style="color:red">*</font>详细地址(不填省市区)：</label>
        ...
        <div class="control-group">
         	<label class="control-label"><font style="color:red">*</font>地图导航：</label>
				<div class="controls">
					<div class="col-sm-6">
        ...
        <div class="control-group">
            <label class="control-label"><font style="color:red">*</font>门店简介：</label>
...
{block script}
    ...
    var action_url = '{route("StoreList")}';
        ...
        $(document).on('click', '#editBelongGroup', function() {
            if ($(".sub_category").is(":visible")) {
                $(this).text('[修改]');
                $(".sub_category:not(:first)").remove();
                $(".sub_category").hide();
            } else {
                $(this).text('[取消修改]');
                $(".sub_category").show();
