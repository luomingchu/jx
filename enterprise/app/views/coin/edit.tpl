...
{block title}指币发放{/block}

{block breadcrumb}
    <li>系统管理<span class="divider">&nbsp;</span></li>
    <li><a href="{route('EditMemberCoin')}">指币发放</a><span class="divider-last">&nbsp;</span></li>
{/block}
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab_1_1" style="padding-left: 20px;">
                                    <form id="group_form">
                                        ...
                                        <div class="control-group">
                                            <div class="controls">
                                                <span style="width: 80px;display: inline-block;">指币：</span>
                                                <input type="text" placeholder="请输入要发放的指币" class="input" id="group_amount" value=""/>
                                ...
                                <div class="tab-pane" id="tab_1_2" style="padding-left: 20px;">
                                    <form id="member_form">
                                        ...
                                        <div class="control-group">
                                            <div class="controls">
                                                <span style="width: 80px;display: inline-block;">指币：</span>
                                                <input type="text" placeholder="请输入要发放的指币" class="input" name="amount" id="member_amount" value=""/>
                                                <span class="help-inline">请输入整数</span>
                                            </div>
                                        </div>
                                        <div class="form-actions">
...
<script type="text/javascript">
    ...
    $("#group_amount,#member_amount").keyup(function() {
        if (! /^[\d]+$/.test($(this).val())) {
            $(this).val('');
        }
    });
    ...
    $("#grantByGroup").click(function() {
        ...
        $("#MessageContent").html('指币发放中，请稍后 <img src="{asset("assets/pre-loader/Fading squares.gif")}"/>');
