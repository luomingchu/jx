...
(function () {
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            hasAttributes: CKEDITOR.env.ie && (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) ? function () {
                ...
                if (document.documentElement.getBoundingClientRect) {
                    var h =
                        this.$.getBoundingClientRect(), l = d.$.documentElement, m = l.clientTop || g.$.clientTop || 0, n = l.clientLeft || g.$.clientLeft || 0, o = true;
                    if (CKEDITOR.env.ie) {
    ...
    (function () {
        function b(a, b) {
            ...
            d = c.endContainer;
            var n = c.startOffset, o = c.endOffset, i, q = this.guard, f = this.type, e = a ? "getPreviousSourceNode" : "getNextSourceNode";
            if (!a && !this._.guardLTR) {
                var j = d.type == CKEDITOR.NODE_ELEMENT ? d : d.getParent(), s = d.type == CKEDITOR.NODE_ELEMENT ? d.getChild(o) : d.getNext();
                this._.guardLTR = function (a, b) {
                    return (!b || !j.equals(a)) && (!s || !a.equals(s)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
                }
            }
            if (a && !this._.guardRTL) {
                var A = m.type == CKEDITOR.NODE_ELEMENT ? m : m.getParent(), B = m.type == CKEDITOR.NODE_ELEMENT ? n ? m.getChild(n - 1) : null : m.getPrevious();
    ...
    (function () {
        function b() {
            var a = false, b = CKEDITOR.dom.walker.whitespaces(), o = CKEDITOR.dom.walker.bookmark(true), c = CKEDITOR.dom.walker.bogus();
            return function (q) {
        ...
        var f = function (a) {
            ...
            u: 1,
            "var": 1
        }, g = CKEDITOR.dom.walker.bogus(), k = new CKEDITOR.dom.walker.whitespaces, h = new CKEDITOR.dom.walker.bookmark, l = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/;
        CKEDITOR.dom.range.prototype = {
            clone: function () {
                ...
                var b = this.startContainer, o = this.endContainer, c = this.startOffset, d = this.endOffset, g = this.collapsed, f, j;
                ...
                if (a.is2) {
                    var b = this.document.getByAddress(a.start, a.normalized), c = a.startOffset, i = a.end && this.document.getByAddress(a.end, a.normalized), a = a.endOffset;
                    this.setStart(b, c);
                ...
                var c = this.startContainer, i = this.endContainer, c = c.equals(i) ? a && c.type == CKEDITOR.NODE_ELEMENT && this.startOffset == this.endOffset - 1 ? c.getChild(this.startOffset) : c : c.getCommonAncestor(i);
                ...
                if (!this.collapsed) {
                    var a = a || CKEDITOR.SHRINK_TEXT, i = this.clone(), d = this.startContainer, g = this.endContainer, f = this.startOffset, e = this.endOffset, k = 1, h = 1;
            ...
            moveToPosition: function (a, b) {
                ...
                var b =
                    new CKEDITOR.dom.elementPath(this.startContainer, this.root), c = new CKEDITOR.dom.elementPath(this.endContainer, this.root), i = b.block, d = c.block, g = null;
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml = function (e, d, g) {
            ...
            var i = new CKEDITOR.htmlParser, q = d instanceof CKEDITOR.htmlParser.element ? d : typeof d == "string" ? new CKEDITOR.htmlParser.element(d) : new CKEDITOR.htmlParser.fragment, y = [], z = [], j = q, s = q.name == "textarea", A = q.name == "pre";
    ...
    (function () {
        ...
        var s = /(?:&nbsp;|\xa0)$/, A = "{cke_protected}", B = CKEDITOR.dtd, p = ["caption", "colgroup", "col", "thead", "tfoot",
            "tbody"], D = CKEDITOR.tools.extend({}, B.$blockLimit, B.$block), u = {
            elements: {},
    ...
    (function () {
        ...
        function a(a) {
            var b = a.name, c = a.element, f = a.elementMode, l = a.fire("uiSpace", {
                space: "top",
                html: ""
            }).html, m = a.fireOnce("uiSpace", {space: "bottom", html: ""}).html;
        ...
        CKEDITOR.editor.prototype.resize = function (a, b, c, e) {
            var f = this.container, m = this.ui.space("contents"), n = CKEDITOR.env.webkit && this.document && this.document.getWindow().$.frameElement, e = e ? f.getChild(1) : f;
    ...
    (function () {
        function b(b) {
            var c = b.editor, d = c.editable(), e = b.data.path, f = e.blockLimit, g = b.data.selection.getRanges()[0], j = c.config.enterMode;
    ...
    (function () {
        ...
        CKEDITOR.on("instanceCreated", function (a) {
            ...
            f.on("contentDom", function () {
                var a = f.document, e = CKEDITOR.document, g = f.editable(), o = a.getBody(), n = a.getDocumentElement(), h = g.isInline();
    ...
    (function () {
        ...
        var p = {
            ...
            audio: 1,
            video: 1
        }, u = /\s*(?:;\s*|$)/, r = /#\((.+?)\)/g, F = CKEDITOR.dom.walker.bookmark(0, 1), v = CKEDITOR.dom.walker.whitespaces(1);
    ...
    (function () {
        ...
        var s = CKEDITOR.tools.cssLength, S = '<div class="cke cke_reset_all {editorId} {editorDialogClass}" dir="{langDir}" lang="{langCode}" role="dialog" aria-labelledby="cke_dialog_title_{id}"><table class="cke_dialog ' + CKEDITOR.env.cssClass +
        ...
        CKEDITOR.dialog.prototype = {
            ...
            addPage: function (a) {
                ...
                var d = CKEDITOR.env, g = "cke_" + a.id + "_" + CKEDITOR.tools.getNextNumber(), c = CKEDITOR.dom.element.createFromHtml(['<a class="cke_dialog_tab"',
    ...
    (function () {
        ...
        function z(b, a, d) {
            ...
            a.writeHtml(c, d);
            var a = c.getHtml(), a = a.replace(/\s*(<\/?[a-z:]+ ?\/?>)\s*/g, "$1").replace(/(<cke:br \/>){2,}/g, "<cke:br />").replace(/(<cke:br \/>)(<\/?p>|<br \/>)/g, "$2").replace(/(<\/?p>|<br \/>)(<cke:br \/>)/g, "$1").replace(/<(cke:)?br( \/)?>/g, "<br>").replace(/<p><\/p>/g, ""), f = 0, a = a.replace(/<\/?p>/g, function (a) {
                if ("<p>" ==
                    a) {
                    if (1 < ++f)return "</p><p>"
    ...
    (function () {
        function p(a, b, c, g, i) {
            var i = CKEDITOR.tools.genKey(b.getUniqueId(), c.getUniqueId(), a.lang.dir, a.uiColor || "", g.css || "", i || ""), e = h[i];
        ...
        CKEDITOR.ui.floatPanel = CKEDITOR.tools.createClass({
            $: function (a, b, c, g) {
                ...
                addBlock: function (a, b) {
                    ...
                    var d = this.element, a = this._.iframe, h = d.getDocument(), n = this._.parentElement.getPositionedAncestor(), o = b.getDocumentPosition(h), h = n ? n.getDocumentPosition(h) : {
                        x: 0,
                        y: 0
                    }, l = "rtl" == this._.dir, f = o.x + (g || 0) - h.x, j = o.y + (i || 0) - h.y;
                    ...
                    CKEDITOR.tools.setTimeout(function () {
                        var a = CKEDITOR.tools.bind(function () {
                            ...
                            var b = e.element.getWindow(), a = d.$.getBoundingClientRect(), b = b.getViewPaneSize(), c = a.width || a.right - a.left, g = a.height || a.bottom - a.top, i = l ? a.right : b.width - a.left, h = l ? b.width - a.right : a.left;
    ...
    (function () {
        ...
        CKEDITOR.menu = CKEDITOR.tools.createClass({
            $: function (a, c) {
                ...
                onShow: function () {
                    var a =
                        this.editor.getSelection(), c = a && a.getStartElement(), b = this.editor.elementPath(), i = this._.listeners;
                    this.removeAll();
                ...
                add: function (a) {
                    ...
                    var c = c || ("rtl" == this.editor.lang.dir ? 2 : 1), e = this.items, j = this.editor, f = this._.panel, h = this._.element;
                    if (!f) {
        ...
        CKEDITOR.menuItem = CKEDITOR.tools.createClass({
            $: function (a, c, b) {
                ...
                render: function (a,
                                  c, b) {
                    var g = a.id + ("" + c), e = "undefined" == typeof this.state ? CKEDITOR.TRISTATE_OFF : this.state, j = e == CKEDITOR.TRISTATE_ON ? "on" : e == CKEDITOR.TRISTATE_DISABLED ? "disabled" : "off", f = this.getItems, h = "&#" + ("rtl" == this.editor.lang.dir ? "9668" : "9658") + ";", d = this.name;
        ...
        init: function (b) {
            ...
            if (!1 !== a.resize_enabled) {
                var c = null, i = ("both" == a.resize_dir || "horizontal" == a.resize_dir) && a.resize_minWidth != a.resize_maxWidth,
                    l = ("both" == a.resize_dir || "vertical" == a.resize_dir) && a.resize_minHeight != a.resize_maxHeight, j = function (e) {
                        var d = f, m = g, c = d + (e.data.$.screenX - n) * ("rtl" == h ? -1 : 1), e = m + (e.data.$.screenY - o);
    ...
    (function () {
        ...
        var b =
            ...
            m = CKEDITOR.addTemplate("buttonArrow", '<span class="cke_button_arrow">' + (CKEDITOR.env.hc ? "&#9660;" : "") + "</span>"), n = CKEDITOR.addTemplate("button", b);
    ...
    (function () {
        ...
        var b = b + (' onkeydown="return CKEDITOR.tools.callFunction({keydownFn},event,this);" onmousedown="return CKEDITOR.tools.callFunction({mousedownFn},event);"  onfocus="return CKEDITOR.tools.callFunction({focusFn},event);" ' + (CKEDITOR.env.ie ? 'onclick="return false;" onmouseup' : "onclick") + '="CKEDITOR.tools.callFunction({clickFn},this);return false;"><span id="{id}_text" class="cke_combo_text cke_combo_inlinelabel">{label}</span><span class="cke_combo_open"><span class="cke_combo_arrow">' +
            (CKEDITOR.env.hc ? "&#9660;" : CKEDITOR.env.air ? "&nbsp;" : "") + "</span></span></a></span>"), h = CKEDITOR.addTemplate("combo", b);
        ...
        CKEDITOR.ui.richCombo = CKEDITOR.tools.createClass({
            $: function (a) {
                ...
                renderHtml: function (a) {
                    ...
                    if (!this._.panel) {
                        var d = this._.panelDefinition, b = this._.panelDefinition.block, h = d.parent || CKEDITOR.document.getBody(), g = "cke_combopanel__" + this.name, e = new CKEDITOR.ui.floatPanel(a, h, d), f = e.addListBlock(this.id, b), c = this;
                        e.onShow = function () {
    ...
    (function () {
        ...
        function $(a) {
            var b = a.doc, d = y('<span contenteditable="false" style="' + E + "position:absolute;border-top:1px dashed " + a.boxColor + '"></span>', b);
            o(d, {
                attach: function () {
        ...
        }(), w = CKEDITOR.dom.walker.whitespaces(), x = CKEDITOR.dom.walker.nodeType(CKEDITOR.NODE_COMMENT), X = function () {
            function a(a) {
                var e =
                    a.element, f, c, h;
    ...
    (function () {
        ...
        function r(c, d, b) {
            ...
            for (var d = c.getDocument(), m = j, l = w = 0, p = !b && new CKEDITOR.dom.documentFragment(d), r = 0, d = 0; d < a.length; d++) {
                f = a[d];
                var n = f.getParent(),
                    s = f.getFirst(), q = f.$.colSpan, t = f.$.rowSpan, n = n.$.rowIndex, x = v(g, n, f), r = r + q * t, l = Math.max(l, x - k + q);
                w = Math.max(w, n - j + t);
                if (!b) {
                    q = f;
