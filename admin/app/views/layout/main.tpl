...
<head>
<meta charset="utf-8" />
<title>{block title}{{$smarty.block.child}|strip_tags|default:'管理中心'} - {/block}指帮创业</title>
	...
	<div id="header" class="navbar navbar-inverse navbar-fixed-top">
		...
		<div class="navbar-inner">
			<div class="container-fluid">
				<!-- begin logo -->
				<a class="brand" href="{route('Dashboard')}"><img src="{asset('img/logo.png')}" alt="" /></a>
				<!-- end logo -->
					...
					<ul class="nav top-menu">
						...
						<li class="dropdown" id="header_inbox_bar">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span class="badge badge-important sys_msg_num hide">0</span>
						    </a>
							<ul class="dropdown-menu extended inbox pull-right" id="sys_msg_viewer">
								<li id="sys_msg_bar"><p>您有<span class="sys_msg_num">0</span>条新的消息</p></li>
								<li><a href="">查看更多历史消息 &gt;&gt;</a></li>
							</ul></li>
						end inbox dropdown
					</ul>
					end notification
				...
				<div class="top-nav">
					<ul class="nav pull-right top-menu">
						...
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							data-toggle="dropdown"> <img src="{Auth::user()->avatar.url|default:asset('img/avatar.png?')}&width=30&height=30" alt="" style="width:30px;height:30px;"> <span
			...
			<div class="container-fluid">
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<script>
								...
								$('.sidebar-menu a[priority="' + maxMenu + '"]:first')
                ...
                <div id="confirmModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn" data-dismiss="modal" id="confirmCancel">取消</button>
                    </div>
                </div>
