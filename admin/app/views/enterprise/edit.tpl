...
{block title prepend}编辑企业  {/block}

{block breadcrumb}
<li>企业管理  <span class="divider">&nbsp;</span></li>
<li><a href="{route('EditEnterprise')}">编辑企业</a> <span class="divider-last">&nbsp;</span></li>
{/block}
...
<div class="row-fluid">
    ...
    <div class="widget">
        ...
        <h4><i class="icon-reorder"> 添加/编辑企业信息</i></h4>
    </div>
    <div class="widget-body form">
    <!-- BEGIN FORM-->
    <form id="form" class="form-horizontal">
    	<div class="control-group">
            <label class="control-label"><font style="color:red">*</font>企业英文标识：</label>
            <div class="controls">
                <input type="text" class="span2" id="domain" name="domain" value="{$data.domain}" {if $data.domain }readonly{/if} placeholder=""/>
                <span class="help-inline">只能填英文，不可修改，做二级域名使用</span>
            </div>
        </div>
        
        <div class="control-group">
            <label class="control-label"><font style="color:red">*</font>企业名称：</label>
        ...
        <div class="control-group">
            <label class="control-label"><font style="color:red">*</font>企业Logo图片：(800*500px)</label>
        ...
        <div class="control-group">
         ...
         <div class="control-group">
            <label class="control-label">详细地址(不填省市区)：</label>
	    ...
	    <div class="control-group">
            <label class="control-label">企业宣传语：</label>

            <div class="controls">
                <input type="text" class="span6" id="legal" name="legal" value="{$data.legal}" placeholder=""/>
                <span class="help-inline"></span>
            </div>
        </div>
        ...
        <div class="control-group">
        	<div class="controls">
        		<input type="hidden" name="enterprise_id" id="enterprise_id"  value="{$data.id}"/>
...
{block script}
    ...
    var action_url = '{route("GetEnterpriseList")}';
